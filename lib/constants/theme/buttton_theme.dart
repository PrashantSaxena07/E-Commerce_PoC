...
import 'package:foot_wear_v6001/constants/theme/theme_provider.dart';
...
class _ThemeButtonState extends State<ThemeButton> {
  ...
  void initState() {
    ...
    //listen true... calling the theme provider from start only, to make theme provider be changed as per request...listen should be false to
